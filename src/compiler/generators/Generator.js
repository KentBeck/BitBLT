...
class Generator {
   ...
   * @returns {Uint32Array|Promise<Uint32Array>} - The destination buffer after the operation (or a Promise that resolves to it)
   */
  execute(
    srcBuffer,
    srcWidth,
  ...
  analyzeOperation(params) {
    throw new Error(
      "Method analyzeOperation() must be implemented by subclass"
    );
  }
